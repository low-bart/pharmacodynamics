...
class BindingGUI:
    def __init__(self, main):
        ...
        '''self.loadBindingPlateButton = tk.Button(self.bindingFrame,
                                            text="Load saved binding assay",
                                            command=self.load_BindingPlate)'''
        self.loadDrugReportsButton = tk.Button(self.bindingFrame, 
                                               text="Load saved DrugReports", 
                                               command=self.load_DrugReports)
        self.generateSummaryTableButton = tk.Button(self.functionFrame,
                                                    text="Generate summary tables",
                                                    command=self.generate_summary_tables)
        self.generateTemplateButton = tk.Button(self.functionFrame,
                                                text="Create excel templates",
                                                command=self.generate_excel_templates)
        self.labelTriplicatesButton = tk.Button(self.triplicateFrame,
...
# interfaces with h5 file to calculate % inhibition                
class ScreeningGUI:
    def __init__(self, main, filepath):
        ...
        self.dateLabel = tk.Label(self.main, text="Select a concentration: ")
